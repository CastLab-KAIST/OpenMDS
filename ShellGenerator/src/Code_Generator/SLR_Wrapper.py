...
def SLR_Wrapper(filedir, board, slr_list, ddr_slr_list=None, ddr_ch_list=None, ddr_dma_list=None, hbm_slr_list=None,  hbm_port_list=None,  hbm_dma_list=None,
