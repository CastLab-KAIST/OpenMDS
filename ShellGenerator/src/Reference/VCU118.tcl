...
################################################################
# This is a generated script based on design: VCU118
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {GPIO_S_AXI_LITE:XDMA_M_AXI:XDMA_M_AXI_LITE} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports dip_switches_4bits] [get_bd_intf_pins GPIO/GPIO]
  ...
  connect_bd_net -net util_ds_buf_IBUF_DS_ODIV2 [get_bd_pins XDMA/sys_clk] [get_bd_pins util_ds_buf/IBUF_DS_ODIV2]
  connect_bd_net -net util_ds_buf_IBUF_OUT [get_bd_pins XDMA/sys_clk_gt] [get_bd_pins util_ds_buf/IBUF_OUT]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces GPIO_S_AXI_LITE] [get_bd_addr_segs GPIO/S_AXI/Reg] -force
