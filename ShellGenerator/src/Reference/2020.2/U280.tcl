...
################################################################
# This is a generated script based on design: U280
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {XDMA_M_AXI:XDMA_M_AXI_LITE} \
  ...
  connect_bd_net -net XDMA_CLK [get_bd_ports XDMA_CLK] [get_bd_pins XDMA/axi_aclk]
  connect_bd_net -net XDMA_CLK_RESETN [get_bd_ports XDMA_CLK_RESETN] [get_bd_pins XDMA/axi_aresetn]
